...
export default function SceneCard({
  ...
  return (
    <div
      ...
      transition-all duration-300 ease-in-out hover:-translate-y-3 hover:scale-[1.02] hover:shadow-2xl
      "
    >
      ...
      <div className="flex flex-1 justify-center flex-col gap-3 mt-2">
        {displayedItems.map((item, index) => (
          ...
          >
            <span
              className="text-xl font-bold text-black truncate mr-2"
              style={{ fontFamily: "cursive" }}
            >
              {item.title}
            </span>
        ...
        {extraItemsCount > 0 && (
          <div className="text-left pr-6 -mt-1">
            <span className="text-azul-noche text-lg font-bold" style={{ fontFamily: "cursive" }}>
              + {extraItemsCount} más...
            </span>
          </div>
        )}
